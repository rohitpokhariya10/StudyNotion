...
import { createSessionResponseHandler } from "../../features/session/model/sessionResponseIntegration"
...
vi.mock("../../components/core/Dashboard/Instructor", () => ({
  default: () => <h1>Instructor route</h1>,
}))
vi.mock("../../components/core/Dashboard/EnrolledCourses", () => ({
  default: () => <h1>Student enrolled route</h1>,
}))
vi.mock("../../components/core/Dashboard/Admin/InstructorApprovals", () => ({
  default: () => <h1>Admin approvals route</h1>,
}))
vi.mock("../../pages/PolicyAcceptance", () => ({
  default: () => <h1>Policy route</h1>,
}))
vi.mock("../../pages/ViewCourse", () => ({
  default: () => <Outlet />,
}))
vi.mock("../../components/core/ViewCourse/VideoDetails", () => ({
