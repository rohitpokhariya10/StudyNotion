...
import { fetchPublicReviews, RatingStars } from "@/entities/review"
import { getAvatarSource, setInitialsAvatarOnError } from "@/entities/user"
// Swiper modules
...
function ReviewSlider() {
  ...
  useEffect(() => {
    ;(async () => {
      try {
        setReviews(await fetchPublicReviews())
      } catch {
        setReviews([])
      }
    })()
