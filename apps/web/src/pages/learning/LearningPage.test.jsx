import ViewCourse from "@/pages/learning"
...
vi.mock("@/entities/learning", async (importOriginal) => ({
  ...(await importOriginal()),
  useGetLearningCourseQuery: learningMocks.query,
}))

vi.mock("@/widgets/curriculum-panel", () => ({
...
vi.mock("@/features/course-review/ui/CourseReviewModal", () => ({
