      ...
      <div className="flex gap-1">
        {RATINGS.map((rating) => {
          ...
          return (
            <label
              key={rating}
              className="cursor-pointer rounded-xs p-1 text-yellow-100 transition-transform hover:scale-110 has-[:disabled]:cursor-not-allowed has-[:disabled]:opacity-60 has-[:focus-visible]:ring-2 has-[:focus-visible]:ring-yellow-50"
            >
              <input
                className="sr-only"
                type="radio"
